...
#Lab exercises: Try it yourself
#Check the type of the array and value for the given array
...
print(arr3)
arr3 = arr1*arr2 #Notice it is exactly the same
print(arr3)
